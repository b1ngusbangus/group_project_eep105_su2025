...
if selected == "Scatterplots":
    ...
    with sc4: 
        image_url8 = "https://raw.githubusercontent.com/b1ngusbangus/group_project_eep105_su2025/main/png/CO2_temp_US_facet.png"
        st.image(image_url8, caption="(Individual finding) US CO2 Emissions and Temperature, separated")
    ...
    with sc5:
        ...
        st.image(image_url9, caption="(Individual finding) Vietnam CO2 Emissions and Temperature, Scaled (1980–2014)")
