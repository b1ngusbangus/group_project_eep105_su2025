...
if selected == "Line Plots":
    ...
    with lp1:
        ...
        st.write("Wow! The CO2 has risen exponentially since the 20th century... Perhaps this change relates to the Industrial Revolution, which has forever changed the way the world moves around and produces things.")
